...
version = {{cookiecutter.plugin_name}}.__version__
# The full version, including alpha/beta/rc tags.
release = {{cookiecutter.plugin_name}}.__version__
...
man_pages = [(master_doc, "{{cookiecutter.plugin_name}}", "{{cookiecutter.name}} Documentation", [author], 1)]
