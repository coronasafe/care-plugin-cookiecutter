...
from {{cookiecutter.plugin_name}}.apps import PLUGIN_NAME
...
REQUIRED_SETTINGS = {
    "{{cookiecutter.plugin_name.capitalize()}}_DUMMY_ENV",
}

DEFAULTS = {
    "{{cookiecutter.plugin_name.capitalize()}}_DUMMY_ENV": "test",
}
